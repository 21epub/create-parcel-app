...
const getDefaultLibraryParams = require("./get-default-params");
const createLibrary = require("./create-cli");
const promptLibraryParams = require("./prompt-params");

module.exports = async () => {
  const defaults = await getDefaultLibraryParams();

  program
    .name("create-parcel-app")
    .version(version)
...
And then you can develop your module code in ./src , Example code in ./example
`);
